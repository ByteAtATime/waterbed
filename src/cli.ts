...
import { createAirtableSchema, text, number, boolean, attachment, multipleAttachments } from '@byteatatime/waterbed';
...
`;
    ...
    console.log(
      `✅ Introspection complete! Schema written to ${OUTPUT_FILE_PATH}`
    );
  } catch (error) {
